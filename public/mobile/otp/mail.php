...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    //         $sql = "INSERT INTO verification (`email`, `otp`, `number`, `expretion_time`,) 
    //                 VALUES 9('$email', '$otp', '$number', '$expretion_time' )";
    ...
    //             $sql = "UPDATE verification SET otp = '$otp', number = '$number', expretion_time = '$expretion_time' 
    ...
    $mail = new EmailSender();
    $mail->sendEmail($email, $type, $otp);
    $response = array("status" => "success", "message" => "Kode OTP berhasil dikirimkan", "otp" => $otp);
