...
<body>
  ...
  <!-- ======= Hero Section ======= -->
    ...
    <div class="content">
        <form action="{{ route('nemu') }}" method="get">
...
<script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=663adce0006cfd001d4da410&product=inline-share-buttons&source=platform" async="async"></script>
